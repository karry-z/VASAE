...
#SBATCH --job-name=F002_eval_dataset
...
echo "=== F002 eval_sae_dataset: GPT-2 layer=${layer} ==="

mkdir -p exp/F002_AlignmentAnalysis/logs

uv run python scripts/analyze/alignment/eval_sae_dataset.py \
    ...
    --max-length 256 \
    --batch-size 32 \
    --output-dir exp/F002_AlignmentAnalysis/eval_dataset \
    --device cuda
