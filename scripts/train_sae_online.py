...
for _lib in ["nvidia/cusparselt/lib/libcusparseLt.so.0", "nvidia/cusparse/lib/libcusparse.so.12"]:
...
def main():
    ...
    logger.info(f"Dead feature rate: {dead_rate:.4f}, L0: {l0:.2f} (over {n_samples} samples)")
