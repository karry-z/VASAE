...
def parse_args():
    ...
    parser.add_argument(
        "--layer-name",
        type=str,
        default="model.language_model.layers.31",
    )
    parser.add_argument(
        "--data-dir",
        type=str,
        default=r"/scratch/b5bq/pu22650.b5bq/activations_llava-hf_llava-1.5-7b-hf_lmms-lab_COCO-Caption",
    )

    # sae config
    parser.add_argument("--dim-input", type=int, default=4096)
    parser.add_argument("--dim-sparse", type=int, default=32000)
    ...
    parser.add_argument(
        "--sae-save-path",
        type=str,
        default=r"/scratch/b5bq/pu22650.b5bq/VASAE_out/sae_llava.pth",
    )
    ...
    parser.add_argument("--wandb-group", type=str, default="llava_coco")

    # blackbox model config
    parser.add_argument("--blackbox-model-name", type=str, default="llava-hf/llava-1.5-7b-hf")
    parser.add_argument(
        "--blackbox-model-dir",
        type=str,
        default=r"/scratch/b5bq/pu22650.b5bq/VASAE_out/BlackBoxModels/llava-hf_llava-1.5-7b-hf",
    )
